...
st.markdown(
    """
Computed in `src/saas_insights/gtm.py` from the monthly driver panel, on a
trailing-twelve-month (TTM) basis unless noted. `base = ending_arr 12 months ago`.
...
- `ltv = new_arr_per_customer * gross_margin / gross_revenue_churn_rate`  (churn = 1 - GRR)
- `ltv_to_cac = ltv / cac`
